...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Tools to help with address data",
    Description = "For example, based on a postcode column, add variables to a data frame such as Ward.",
    `Authors@R` = c(
      person("Laurie", "Platt", email = "laurie.platt@sheffield.gov.uk", role = c("aut", "cre")))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Laurie Platt")
```
